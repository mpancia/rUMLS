...
search_UMLS <- function(search, inputType = "sourceUi", includeObsolete = FALSE, 
    ...
    exhaust_search(FUN = search_UMLS_page, PARSER = parse_search, search = search, 
        inputType = inputType, includeObsolete = includeObsolete, includeSuppressible = includeSuppressible, 
